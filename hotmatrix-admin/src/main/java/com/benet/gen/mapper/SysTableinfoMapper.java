...
public interface SysTableinfoMapper 
{
     ...
     * @return 代码生成业务集合
     */
    public List<SysTableinfo> getRecordsByClassNo( @Param("classNo" ) String classNo);
     ...
     * @return 代码生成业务集合
     */
    public List<SysTableinfo> getRecordsByPaging( @Param("model" ) PagingModel model);
     ...
     * @return 代码生成业务
     */
    public SysTableinfo getRecordByNo(@Param("no" ) String no);
