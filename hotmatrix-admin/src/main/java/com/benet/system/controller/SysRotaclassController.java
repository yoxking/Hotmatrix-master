...
public class SysRotaclassController extends BaseController
{
    ...
    public TableDataInfo list(@RequestBody PageRequest pRequest)
    {
        ...
        int count = sysRotaclassService.getCountByCondition(loginUser.getUser().getAppCode(),pRequest.getCondition());
        List<SysRotaclass> list = sysRotaclassService.getRecordsByPaging(loginUser.getUser().getAppCode(),pRequest.getPageIndex(), pRequest.getPageSize(), pRequest.getCondition(), "id", "Asc");
    ...
    {
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        int count = sysRotaclassService.getCountByCondition(loginUser.getUser().getAppCode(),"");
    ...
    public AjaxResult insert(@RequestBody SysRotaclass sysRotaclass) {
        ...
        sysRotaclass.setCreateBy(loginUser.getUser().getUserNo());
        sysRotaclass.setUpdateBy(loginUser.getUser().getUserNo());
        return toAjax(sysRotaclassService.AddNewRecord(loginUser.getUser().getAppCode(),sysRotaclass));
    }
    ...
    @PutMapping
        public AjaxResult update(@RequestBody SysRotaclass sysRotaclass) {
            LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        sysRotaclass.setUpdateBy(loginUser.getUser().getUserNo());
            return toAjax(sysRotaclassService.UpdateRecord(loginUser.getUser().getAppCode(),sysRotaclass));
        }
    ...
    public AjaxResult save(@RequestBody SysRotaclass sysRotaclass) {
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        if (StringUtils.isNull(sysRotaclassService.getRecordByNo(loginUser.getUser().getAppCode(),sysRotaclass.getClassNo()))) {
            sysRotaclass.setClassNo(UuidUtils.shortUUID());
            sysRotaclass.setCreateBy(loginUser.getUser().getUserNo());
            sysRotaclass.setUpdateBy(loginUser.getUser().getUserNo());
            return toAjax(sysRotaclassService.AddNewRecord(loginUser.getUser().getAppCode(),sysRotaclass));
    ...
    {
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        return toAjax(sysRotaclassService.SoftDeleteByNos(loginUser.getUser().getAppCode(),ids));
    }
    ...
    {
        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
        return AjaxResult.success(sysRotaclassService.getRecordByNo(loginUser.getUser().getAppCode(),id));
    }
    ...
    public AjaxResult export(@RequestBody PageRequest pRequest)
    {
        ...
        List<SysRotaclass> list = sysRotaclassService.getRecordsByPaging(loginUser.getUser().getAppCode(),1,count,pRequest.getCondition(),"id","Asc");
