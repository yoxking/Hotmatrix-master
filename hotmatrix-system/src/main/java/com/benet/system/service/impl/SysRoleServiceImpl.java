...
import com.benet.system.service.ISysRoleService;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    {
        Long[] roleIds = ConvertHelper.toLongArray(ids);
    ...
    {
        return userRoleMapper.deleteUserRoleInfos(roleId, ConvertHelper.toLongArray(userIds));
    }
    ...
    {
        Long[] users = ConvertHelper.toLongArray(userIds);
        // 新增用户与角色管理
