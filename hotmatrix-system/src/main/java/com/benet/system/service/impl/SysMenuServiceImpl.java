...
import com.benet.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
     ...
     */
    @Override
    public List<ZtreeEntity> roleMenuTreeData(SysRole role, Long userId)
    {
     ...
     */
    @Override
    public List<ZtreeEntity> menuTreeData(Long userId)
    {
        List<SysMenu> menuList = selectMenuAll(userId);
        List<ZtreeEntity> ztrees = initZtree(menuList);
        return ztrees;
    }
     ...
     * @return 树结构列表
     */
    public List<ZtreeEntity> initZtree(List<SysMenu> menuList)
    {
     ...
     * @return 树结构列表
     */
    public List<ZtreeEntity> initZtree(List<SysMenu> menuList, List<String> roleMenuList, boolean permsFlag)
    {
        List<ZtreeEntity> ztrees = new ArrayList<ZtreeEntity>();
