...
public class ActivityInstance extends AbstractNodeInstance implements
    ...
    public transient static final String Extension_Target_Name = "com.benet.fireflow.kernel.ActivityInstance";
     ...
     */
    public void complete(ITokenInstance token, IActivityInstance targetActivityInstance) throws KernelException {
