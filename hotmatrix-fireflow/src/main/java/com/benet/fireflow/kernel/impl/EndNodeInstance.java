...
public class EndNodeInstance extends AbstractNodeInstance implements
    ...
    public static final String Extension_Target_Name = "com.benet.fireflow.kernel.EndNodeInstance";
    ...
    public void fire(ITokenInstance tk) throws KernelException {
        ...
        if (joinPoint.getAlive()) {
            ITokenInstance tokenForLoop = null;

                tokenForLoop = new TokenInstance(); // 产生新的token
