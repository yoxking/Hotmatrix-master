...
import com.benet.fireflow.kernel.INodeInstance;
...
public class NetInstance implements INetInstance {
    ...
    public void run(IProcessInstance processInstance) throws KernelException {
        ...
        TokenInstance token = new TokenInstance();//初始化token
        ...
        token.setFromActivityId(ITokenInstance.FROM_START_NODE); //从哪个节点来 "FROM_START_NODE" 规定的节点。
