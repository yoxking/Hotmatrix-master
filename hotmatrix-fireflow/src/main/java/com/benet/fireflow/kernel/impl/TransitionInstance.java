...
import com.benet.fireflow.kernel.plugin.IPlugable;
...
public class TransitionInstance extends EdgeInstance implements ITransitionInstance, IPlugable {
    ...
    public transient static final String Extension_Target_Name = "com.benet.fireflow.kernel.TransitionInstance";
     ...
     */
    public boolean take(ITokenInstance token) throws KernelException {
