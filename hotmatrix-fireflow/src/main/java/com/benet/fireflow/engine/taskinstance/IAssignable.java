...
public interface IAssignable {
     ...
     */
    public IWorkItemInstance assignToActor(String actorId) throws EngineException,KernelException;
     ...
     * @throws org.fireflow.kenel.KenelException
     */
    public List<IWorkItemInstance> assignToActors(List<String> actorIds) throws EngineException,KernelException;
