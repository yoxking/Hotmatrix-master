...
import com.benet.fireflow.engine.impl.ProcessInstanceVar;
...
public interface IPersistenceService extends IRuntimeContextAware{
     ...
     * @return
     */
    public IWorkTaskInstance findAliveTaskInstanceById(String id);
     ...
     * @return
     */
    public List<IWorkTaskInstance> findTaskInstancesForProcessInstance(String processInstanceId, String activityId);
     ...
     */
    public void saveOrUpdateWorkItemInstance(IWorkItemInstance workitemInstance);
     ...
     * @return
     */
    public List<IWorkItemInstance> findTodoWorkItems(String actorId, String processId, String taskId);
     ...
     * @return
     */
    public List<IWorkItemInstance> findHaveDoneWorkItems(String actorId);
     ...
     * @return
     */
    public List<IWorkItemInstance> findHaveDoneWorkItems(String actorId, String processInstanceId);
     ...
     * @return
     */
    public List<IWorkItemInstance> findHaveDoneWorkItems(String actorId, String processId, String taskId);
     ...
     * @return
     */
    public ITokenInstance findTokenById(String id);
     ...
     * @param token
     */
    public void deleteToken(ITokenInstance token);
     ...
     * 根据processName返回最新版本的有效流程定义
     * @param processName the workflow process name
     * @return
     */
     ...
     * @throws RuntimeException
     */
	public List<IWorkItemInstance> findTodoWorkItems(String actorId, String publishUser, int pageSize, int pageNumber) throws RuntimeException;
	 ...
	 * @throws RuntimeException
	 */
	public List<IWorkItemInstance> findHaveDoneWorkItems(String actorId, String publishUser, int pageSize, int pageNumber) throws RuntimeException;
