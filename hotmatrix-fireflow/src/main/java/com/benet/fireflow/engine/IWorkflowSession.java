...
public interface IWorkflowSession {
	 ...
	 *         ）<br>
	 *         2、工作流引擎对象的列表、3、null
	 * @throws com.benet.fireflow.engine.EngineException
	 * @throws com.benet.fireflow.kernel.KernelException
	 */
	 ...
	 * @return 新创建的流程实例
	 */
	public IProcessInstance createProcessInstance(String workflowProcessName,String creatorId) throws EngineException, KernelException;
...
//			String creatorId) throws EngineException, KernelException;
	 ...
	 */
	public List<IWorkItemInstance> findMyTodoWorkItems(String actorId);
     ...
     * 
     */
	public IWorkItemInstance claimWorkItem(String workItemId) throws EngineException, KernelException ;
	 ...
	 * @throws com.benet.fireflow.kernel.KernelException
	 */
    public IWorkItemInstance withdrawWorkItem(String workItemId)throws EngineException, KernelException;
     ...
     * @return 新创建的工作项
     */    
    public IWorkItemInstance reassignWorkItemTo(String workItemId, String actorId) throws EngineException;
     ...
     * @return 新创建的工作项
     */    
    public IWorkItemInstance reassignWorkItemTo(String workItemId, String actorId, String comments) throws EngineException;
	 ...
	 * @return 被挂起的任务实例
	 */
    public IWorkTaskInstance suspendTaskInstance(String taskInstanceId)throws EngineException;
     ...
     * @throws EngineException
     */
    public IWorkTaskInstance restoreTaskInstance(String taskInstanceId)throws EngineException;
