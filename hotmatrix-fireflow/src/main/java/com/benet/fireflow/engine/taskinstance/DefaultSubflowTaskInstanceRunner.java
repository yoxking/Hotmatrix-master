...
public class DefaultSubflowTaskInstanceRunner implements ITaskInstanceRunner {
    ...
    public void run(IWorkflowSession currentSession, RuntimeContext runtimeContext, IProcessInstance processInstance,
        ...
        ((WorkTaskInstance) taskInstance).setStartedTime(runtimeContext.getCalendarService().getSysDate());
        ...
        //初始化流程变量,从父实例获得初始值
        Map<String ,Object> processVars = ((WorkTaskInstance) taskInstance).getAliveProcessInstance().getProcessInstanceVariables();
