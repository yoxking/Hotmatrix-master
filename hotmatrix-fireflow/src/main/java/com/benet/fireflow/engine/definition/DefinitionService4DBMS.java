...
public class DefinitionService4DBMS implements IDefinitionService {
    ...
    public WorkflowDefinition getWorkflowDefinitionByProcessNameAndVersionNumber(String processName, Integer version) {
        return rtCtx.getPersistenceService().findWorkflowDefinitionByProcessNameAndVersionNumber(processName, version);
    }
    ...
    public WorkflowDefinition getTheLatestVersionOfWorkflowDefinition(String processName) {
        return rtCtx.getPersistenceService().findTheLatestVersionOfWorkflowDefinitionByProcessName(processName);
    }
