...
public class WorkItemInstance implements IWorkItemInstance, IRuntimeContextAware, IWorkflowSessionAware, java.io.Serializable {
    ...
    private IWorkTaskInstance taskInstance;
    ...
    public WorkItemInstance(WorkTaskInstance taskInstance) {
        this.id= UuidUtils.shortUUID();
     ...
     * @param taskInstance
     */
    public WorkItemInstance(Integer state, Date createdTime, Date signedTm,
                    Date endTime, String comments, WorkTaskInstance taskInstance) {
        this.id= UuidUtils.shortUUID();
        this.state = state;
    ...
    public void setTaskInstance(IWorkTaskInstance taskInstance) {
        this.taskInstance = taskInstance;
    ...
    public void complete(DynamicAssignmentHandler dynamicAssignmentHandler, String comments)
        ...
        if (this.getState().intValue() != IWorkItemInstance.RUNNING) {
            WorkTaskInstance thisTaskInst = (WorkTaskInstance) this.getTaskInstance();
//			System.out.println("WorkItem的当前状态为"+this.getState()+"，不可以执行complete操作。");
    ...
    public IWorkItemInstance claim() throws EngineException, KernelException {
        ...
        IWorkItemInstance newWorkItem = taskInstanceMgr.claimWorkItem(this.getId(),this.getTaskInstance().getId());
        ...
        if (newWorkItem!=null){
            ...
            this.state = IWorkItemInstance.CANCELED;
        }
