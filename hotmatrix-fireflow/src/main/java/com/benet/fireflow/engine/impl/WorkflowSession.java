...
import com.benet.fireflow.engine.IWorkflowSessionCallback;
...
import com.benet.fireflow.model.DataField;
...
public class WorkflowSession implements IWorkflowSession, IRuntimeContextAware {
	...
	public IProcessInstance createProcessInstance(String workflowProcessName,
			IWorkTaskInstance parentTaskInstance) throws EngineException,
			KernelException {
	...
	protected IProcessInstance _createProcessInstance(String workflowProcessId,
		...
		IProcessInstance processInstance =  (IProcessInstance) this.execute(new IWorkflowSessionCallback() {
			...
			public Object doInWorkflowSession(RuntimeContext ctx)
				...
				//processInstance.setId(UuidUtils.shortUUID());
	 ...
	 */
	public IWorkItemInstance findWorkItemById(String id) {
		final String workItemId = id;
		try {
			return (IWorkItemInstance) this.execute(new IWorkflowSessionCallback() {
	 ...
	 */
	public IWorkTaskInstance findTaskInstanceById(String id) {
		final String taskInstanceId = id;
		try {
			return (IWorkTaskInstance) this.execute(new IWorkflowSessionCallback() {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<IWorkItemInstance> findMyTodoWorkItems(final String actorId) {
		List<IWorkItemInstance> result = null;
		try {
			result = (List<IWorkItemInstance>) this.execute(new IWorkflowSessionCallback() {
	 ...
	 */
	public IWorkItemInstance claimWorkItem(final String workItemId)
			throws EngineException, KernelException {
		IWorkItemInstance result = null;
		IWorkItemInstance wi = this.findWorkItemById(workItemId);
		result = wi.claim();
		return result;
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<IWorkTaskInstance> findTaskInstancesForProcessInstance(
			final String processInstanceId, final String activityId) {
		try {
			return (List<IWorkTaskInstance>) this
					.execute(new IWorkflowSessionCallback() {
	 ...
	 */
	public IWorkItemInstance reassignWorkItemTo(String workItemId, String actorId)
			throws EngineException {
		IWorkItemInstance workItem = this.findWorkItemById(workItemId);
	 ...
	 */
	public IWorkTaskInstance restoreTaskInstance(String taskInstanceId)
			throws EngineException {
		IWorkTaskInstance taskInst = this.findTaskInstanceById(taskInstanceId);
		taskInst.restore();
		return taskInst;
	}
	 ...
	 */
	public IWorkTaskInstance suspendTaskInstance(String taskInstanceId)
			throws EngineException {
		IWorkTaskInstance taskInst = this.findTaskInstanceById(taskInstanceId);
		taskInst.suspend();
		return taskInst;
	 ...
	 */
	public IWorkItemInstance withdrawWorkItem(final String workItemId)
			throws EngineException, KernelException {
		IWorkItemInstance wi = this.findWorkItemById(workItemId);
		return wi.withdraw();
	}
