...
public interface IWorkItemInstance {
   ...
   public Date getClaimedTime();
     ...
     * @return
     */
    public IWorkTaskInstance getTaskInstance();
     ...
     */
    public IWorkItemInstance claim() throws EngineException, KernelException;
     ...
     * @throws com.benet.fireflow.kernel.KernelException
     */
    public IWorkItemInstance withdraw()throws EngineException, KernelException;
     ...
     * @return 新创建的工作项
     */    
    public IWorkItemInstance reassignTo(String actorId) throws EngineException;
     ...
     * @return 新创建的工作项
     */    
    public IWorkItemInstance reassignTo(String actorId, String comments) throws EngineException;
