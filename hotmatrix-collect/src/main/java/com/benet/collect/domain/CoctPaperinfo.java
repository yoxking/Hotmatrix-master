...
/**
 * 问卷信息对象 coct_paperinfo
 * 
 * @author yoxking
 * @date 2020-12-19
 */
public class CoctPaperinfo extends BaseEntity
{
    ...
    public void setPaperQnums(Integer paperQnums) 
    {
        this.paperQnums = paperQnums;
    }

    public Integer getPaperQnums() 
    {
        return paperQnums;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("paperQnums", getPaperQnums())
            .append("paperQsets", getPaperQsets())
            .append("paperQuests", getPaperQuests())
            .append("paperQrules", getPaperQrules())
