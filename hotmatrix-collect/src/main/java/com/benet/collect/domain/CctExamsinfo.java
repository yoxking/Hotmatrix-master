...
/**
 * 测评信息对象 cct_examsinfo
 * 
 * @author yoxking
 * @date 2020-11-10
 */
public class CctExamsinfo extends BaseEntity
{
    ...
    /** 测评类别（1:手动生成，2：随机生成） */
    @Excel(name = "测评类别", readConverterExp = "1=:手动生成，2：随机生成")
    ...
    public void setExamsPassmark(Long examsPassmark) 
    {
        this.examsPassmark = examsPassmark;
    }

    public Long getExamsPassmark() 
    {
