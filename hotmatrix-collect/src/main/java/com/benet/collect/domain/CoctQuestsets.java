...
/**
 * 题库信息对象 coct_questsets
 * 
 * @author yoxking
 * @date 2020-12-19
 */
public class CoctQuestsets extends BaseEntity
{
    ...
    public void setSetsType(String setsType) 
    {
        this.setsType = setsType;
    }

    public String getSetsType() 
    {
        return setsType;
    }
