...
public interface CctQuestflowsMapper 
{
     ...
     * @return 答题结果集合
     */
    public List<CctQuestflows> getAllRecords(@Param("appCode") String appCode);
     ...
     * @return 结果
     */
    public int AddNewRecord(@Param("info") CctQuestflows info);
     ...
     * @return 结果
     */
    public int UpdateRecord(@Param("info") CctQuestflows info);
