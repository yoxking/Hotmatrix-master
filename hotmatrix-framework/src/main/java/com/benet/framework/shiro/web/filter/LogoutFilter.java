package com.benet.framework.shiro.web.filter;
        ...
        try
        {
            ...
            try
            {
                ...
                if (StringUtils.isNotNull(user))
                {
                    ...
                    // 记录用户退出日志
                    AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, PubConstants.LOGOUT, MessageUtils.message("user.logout.success")));
                    // 清理缓存
