package com.benet.framework.interceptor.impl;
 ...
 */
@Component
public class SameUrlDataInterceptor extends ResubmitInterceptor
{
    ...
    {
        // 本次参数及系统时间
        String nowParams = JsonHelper.marshal(request.getParameterMap());
